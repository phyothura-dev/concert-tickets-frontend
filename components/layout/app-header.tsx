      ...
      <div className="mx-auto flex h-16 w-full max-w-8xl items-center justify-between gap-4 px-4 sm:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <nav className="hidden items-center gap-1 rounded-full bg-white/60 p-1 md:flex">
            <Button
              asChild
              className="h-8 rounded-full bg-violet-100 px-4 text-violet-700 hover:bg-violet-100"
              variant="ghost"
            >
              <Link href="/">Home</Link>
            </Button>
            <Button
              asChild
              className="h-8 rounded-full px-4 text-slate-600 hover:bg-white hover:text-slate-950"
              variant="ghost"
            >
